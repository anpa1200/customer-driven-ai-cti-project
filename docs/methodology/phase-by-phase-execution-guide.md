...
slug: /methodology/phase-by-phase-execution-guide
description: Phase 0 through Phase 14 execution guide for CTI-to-detection delivery.
---
...
Combined Rating: [Source Reliability letter][Information Credibility number] — e.g., B4
Rating rationale:
AI-assisted source handling: yes / no. If yes, record whether AI was used for summarization, extraction, translation, mapping, or claim generation. Unsupported AI-generated claims default to F6 unless independently corroborated by human-verifiable non-AI evidence. Rate traceable underlying sources separately.
...
*Source rating definitions, combined notation standard, CTI-specific examples, and AI-generated source constraints: [Part 1 → Source Reliability and Information Credibility](https://medium.com/@1200km/customer-driven-ai-cti-project-template-part-1-foundations-745861507d03#890f).*
