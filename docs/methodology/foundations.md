...
slug: /methodology/foundations
description: Analytic standards, governance, scoring, roles, artifacts, and detection readiness foundations.
---
...
**Continue to [Part 2A: Phase-by-Phase Execution Guide](/docs/methodology/phase-by-phase-execution-guide)**
...
**Continue to [Part 2B: Reference Toolkit](/docs/methodology/reference-toolkit)**
